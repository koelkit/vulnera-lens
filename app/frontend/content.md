# 🛡️ Simple Vulnerability Calculator
...
### 1. Identify Your Software
Enter the vendor and product details below to query the global CVE registry.

### 2. Choose Scan Method
Select how you want to calculate your risk profile. If you don't know the exact version, use the **Time Capsule Scan**.
